...
<title>CS 518 Networked Entertainment - Spring 2018 (Turkcell Section)</title>
...
<table style="padding:5;border-spacing:5;width:75%;margin: 0 auto">
	<tr>
		<td>
		<h1>CS 518 Networked Entertainment - Spring 2018 (Turkcell Section)</h1>
		...
		<h2>Logistics </h2>
		<strong>Meeting Time:</strong> Thursdays @4:30pm (For schedule changes, check Google Classroom announcements)
		<br>
