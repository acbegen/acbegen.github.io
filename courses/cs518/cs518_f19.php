...
<title>CS 518 Networked Entertainment - Fall 2019 (Turkcell Section)</title>
...
<table style="padding:5;border-spacing:5;width:75%;margin: 0 auto">
	<tr>
		<td>
		<h1>CS 518 Networked Entertainment - Fall 2019 (Turkcell Section)</h1>
		...
		<h2>Logistics </h2>
		<strong>Time and Location:</strong> Thursdays @4:30pm (For schedule changes, check Google Classroom announcements)
		<br>
		<strong>Google Classroom Link:</strong>
            Go <a href="https://classroom.google.com">here</a> and join the CS 518 class <u>using your OzU (not personal) account</u>. Make sure you receive notifications for the class announcements.
            <br>
