...
<title>CS 623.715: Selected Topics in Computer and Network Architecture: Video Delivery over IP - Summer 2016</title>
</head>
...
<table align="center" cellpadding="5" cellspacing="5" style="width: 75%">
	<tr>
		<td>
		<h1>CS 623.715: Selected Topics in Computer and Network Architecture: Video Delivery over IP - Summer 2016</h1>
		<strong>Instructor: </strong> <a href="http://ali.begen.net">Dr. Ali Cengiz Beğen</a><br>
		<strong>Email:</strong> ali.begen AT aau.at<br>
		<strong>Office Hours:</strong> Make an appointment in advance by email
		<h2>Logistics </h2>
		<strong>Location and Time:</strong> <a href="https://campus.aau.at/studien/lvkarte.jsp?sprache_nr=35&rlvkey=85197">Up-to-date information</a>
		<br>
		<strong>Website:</strong>
		http://ali.begen.net/courses/cs623.715/cs623.715_s16.php<br><strong>Textbook:</strong>
		...
		<h2>Grading</h2>
		<p><a href="cs623.715_s16_grading.pdf">Grades</a> (as of July 18th)</p>
		<ul>
			<li>Exam - 60%</li>
			<li>Project - 40%</li>
		</ul>
		...
		<ul>
			<li>Exam: May 9th, 3:30pm in the class</li>
			<li>Project submissions: <span class="s_linethrough">Late June</span> Mid July (Details)</li>
		</ul>
		<h2>Course Materials</h2>
            <p>The slides we cover in the class are available here.</p>

						<h2>Survey Results</h2>
						<ul>
							<li><a href="survey623.715.pdf" target="_blank">School's survey</a></li>
							<li><a href="https://www.surveymonkey.com/results/SM-JNRYH8BT/" target="_blank">SurveyMonkey</a></li>
						</ul>
				</td>
	</tr>
	<tr>
