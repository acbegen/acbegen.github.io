...
<title>CS 418/518 Networked Entertainment - Spring 2018 (OzU Section)</title>
</head>
...
<table style="padding:5;border-spacing:5;width:75%;margin: 0 auto">
	<tr>
		<td>
		<h1>CS 418/518 Networked Entertainment - Spring 2018 (OzU Section)</h1>
		...
		<h2>Logistics </h2>
		<strong>Time and Location:</strong> Thursdays @12:40pm (AB1.231) (For schedule changes, check Google Classroom announcements)
		<br>
		<strong>Google Classroom Link:</strong>
            ...
            <strong>Textbook:</strong> There is no specific textbook for this class. But, the following books are good references.<br>
                <ul>
                    ...
                    <li><a href="http://www.mypearsonstore.com/bookstore/computer-networking-a-top-down-approach-0133594149" target="_blank">
		Computer Networking: A Top-Down Approach, 7/e</a></li>
