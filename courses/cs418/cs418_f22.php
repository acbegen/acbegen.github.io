...
<head>
  ...
  <title>CS 418/518 Networked Entertainment - Fall 2022</title>
...
<body>
  <table style="padding:5;border-spacing:5;width:75%;margin: 0 auto">
    <tr>
      <td>
        <h1>CS 418/518 Networked Entertainment - Fall 2022</h1>
        ...
        <h2>Logistics </h2>
        <strong>Time and Location:</strong> Wednesdays 9am-11:30am (For schedule changes and Zoom info, check Google Classroom)
        <br>
        ...
        <ul>
          ...
          <li><a href="https://www.pearson.com/en-us/subject-catalog/p/computer-networking/P200000003334/9780135928615" target="_blank"> Computer Networking: A Top-Down Approach</a></li>
          <li><a href="http://lavalle.pl/vr/" target="_blank">Virtual Reality</a> (Online)</li>
          <li><a href="https://webrtcforthecurious.com/" target="_blank">WebRTC for the Curious</a> (Online)</li>
        </ul>
        <strong>TA:</strong> TBD
        ...
        deployments.<br>
        <strong>Prerequisites:</strong> Having a solid computer
